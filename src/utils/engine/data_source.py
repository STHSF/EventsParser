...
__DNS = {
    ...
    'VISIONTEST': {
        URL: 'mysql+mysqlconnector://root:1234@10.15.97.128:3306/test',
        DTYPE: SQLALCHEMY
    },

    'VISION': {
        URL: 'mysql+mysqlconnector://root:1234@10.15.97.128:3306/vision',
        DTYPE: SQLALCHEMY
    },
    ...
    'XAVIER_SQLITE': {
        ...
        URL: 'sqlite://///Users/li/PycharmProjects/event_parser/src/parser/discuss_parser/discuss_data/discuss.db',
        DTYPE: SQLALCHEMY
    }
